...
<small>
  Source: [Github
  Docs](//docs.github.com/en/developers/apps/managing-github-apps/installing-github-apps#authorizing-users-during-installation)
</small>
...
[![GitHub apps show configure if already installed](/configure-ss.png)](/configure-ss.png)
